...
def convert_videos(df, in_path, out_path, out_name=None, vmode=True, vertpix=None, imquality=0.35, suffix_in='MOV', suffix_out='mp4'):
    ...
    for c_row in df.index:
        ...
        if out_name is None:
            ...
            tot_out_path = out_path + os.path.sep + out_name + '.' + suffix_out
...
def convert_masked_videos(df, in_path, out_path, out_name=None, vmode=True, imquality=0.35, suffix_in='MOV', suffix_out='mp4', maskpath=None):
    """ Uses videotools to convert videos from experiments
    ...
    for c_row in df.index:
        ...
        # Create movie
        vt.vid_convert(tot_in_path, tot_out_path, imQuality=imquality, vMode=vmode, maskpath=maskpath)
